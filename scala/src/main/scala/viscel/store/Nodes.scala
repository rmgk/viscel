...
import viscel.store.nodes.{AssetNode, BlobNode, ChapterNode, CollectionNode, ConfigNode, CoreNode, PageNode, UserNode}
...
object Nodes {
	...
	object update {
		def core(desc: Description.Core)(implicit neo: Neo): CoreNode = neo.txs {
