...
import viscel.wrapper.{Flipside, Everafter, CitrusSaburoUta, Misfile, Twokinds}
...
object Clockwork {
	...
	lazy val availableCores: Seq[Core] = Seq(Flipside, Everafter, CitrusSaburoUta, Misfile, Twokinds)
}
