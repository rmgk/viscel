...
object Coin {
	...
	implicit val chapterCodec: NeoCodec[Chapter] = NeoCodecs.case2RW[Chapter, String, String](label.Chapter, "name", "metadata")(
		readf = (n, md) => Chapter(n, upickle.read[Map[String, String]](md)),
		writef = chap => (chap.name, upickle.write(chap.metadata)))

	implicit val assetCodec: NeoCodec[Asset] = NeoCodecs.case3RW[Asset, String, String, String](label.Asset, "source", "origin", "metadata")(
	...
	implicit val moreCodec: NeoCodec[More] = NeoCodecs.case2RW[More, String, String](label.More, "loc", "kind")(
		readf = (l, p) => More(l, p),
		writef = more => (more.loc, more.kind))

	implicit val blobCodec: NeoCodec[Story.Blob] = NeoCodecs.case2RW[Blob, String, String](label.Blob, "sha1", "mediatype")(
		readf = Blob.apply,
		writef = Blob.unapply _ andThen (_.get))

	implicit val coreCodec: NeoCodec[Core] = NeoCodecs.case4RW[Core, String, String, String, String](label.Core, "kind", "id", "name", "metadata")(
